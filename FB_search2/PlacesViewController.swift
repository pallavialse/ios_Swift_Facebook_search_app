...
class PlacesViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, CLLocationManagerDelegate {
    ...
    func fetchData() -> Void{
        Alamofire.request(
            ...
            method: .get,
            parameters: ["keyword": queryWord, "tab": "place", "latitude": latitude , "longitude" : longitude])
            .validate()
...
//                print(response.error as Any)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "PlacesToDetails", sender: Any?.self) /* change */
    }
